...
(
    ...
    dj_second_unitid   string comment '对接二级单位id',
    dj_second_unitname string comment '对接二级单位名称',
    dj_third_unitid    string comment '对接三级单位id',
    dj_third_unitname  string comment '对接三级单位名称',
...
select a.id                                                                                             as attach_id           --附件id
     ...
     , a.djcoid                                                                                         as dj_unitid              --对接单位id
     , org_rule.oname                                                                                   as dj_unitname         --对接单位名称
     , org_rule.second_unit_id                                                                          as dj_second_unitid   --对接二级单位id(非直取,请注意查看文档进行调整)
     , org_rule.second_unit_name                                                                        as dj_second_unitname --对接二级单位名称(非直取,请注意查看文档进行调整)
     , org_rule.third_unit_id                                                                           as dj_third_unitid    --对接三级单位id(非直取,请注意查看文档进行调整)
     , org_rule.third_unit_name                                                                         as dj_third_unitname  --对接三级单位名称(非直取,请注意查看文档进行调整)
