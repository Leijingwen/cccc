...
(
    ...
    capital_source       string comment '资金来源',
    firr                 string comment '财务内部收益率',
    fnpv                 Decimal(20, 6) comment '财务净现值',
    payback_period       Decimal(38, 15) comment '投资回收期（年）',
    ...
    projstage_code       string comment '项目阶段编码',
    projstage_name       string comment '项目阶段名称',
    ...
    own_unit_id          string comment '所属机构编码',
    ...
    adjust_statue_code   string comment '调整状态编码',
    adjust_statue_name   string comment '调整状态名称',
    ...
    ispushiniti          string comment '是否推送至财务系统',
...
select t1.plid                                                                                                             as plid                 --投资计划id
     ...
     , t1.source                                                                                                           as capital_source       --资金来源
     , t1.firr                                                                                                             as firr                 --财务内部收益率
     , t1.fnpv                                                                                                             as fnpv                 --财务净现值
     , t1.pt                                                                                                               as payback_period       --投资回收期（年）
     ...
     , t1.stage                                                                                                            as projstage_code       --项目阶段编码
     , t1.stagename                                                                                                        as projstage_name       --项目阶段名称
     ...
     , t1.coid                                                                                                             as own_unit_id          --所属机构编码
     , org.oname                                                                                                           as own_unit_name        --所属机构名称(非直取,请注意查看文档进行调整)
     ...
     , t1.isedit                                                                                                           as adjust_statue_code   --调整状态编码
     , dict_tzzt.diname                                                                                                    as adjust_statue_name   --调整状态名称(非直取,请注意查看文档进行调整)
     ...
     , t1.ispushiniti                                                                                                      as ispushiniti          --是否推送至财务系统
     ...
     , 'dim_erms_dictitem_d,dim_erms_orgext_d,ods_cccc_erms_invm_plan_year_planedit_i_d,ODS_CCCC_ERMS_ZMDGS_ACTORGINF_F_D' as source_table
from t1
