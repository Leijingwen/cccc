...
drop table ods.ods_cccc_erms_invm_plan_year_apply2plan_i_d;
...
create table dwd.dwd_erms_invm_plan_year_apply1plan_d
(
...
--insert overwrite table dwd.dwd_erms_invm_plan_year_apply1plan_d partition(etl_date = '${etl_date}')
