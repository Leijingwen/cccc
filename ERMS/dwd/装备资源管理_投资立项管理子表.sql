...
--     receivetime          string comment '接收时间',
    op_unitid               string comment '提报单位id',
    op_unitname             string comment '提报单位名称',
--     dj_unitid            string comment '对接单位id',
--     dj_unitname          string comment '对接单位名称',
    op_second_unitid        string comment '填报二级单位id',
    op_second_unitshortname string comment '填报二级单位简称',
...
--      , t1.receivetime                                                                 as receivetime          --接收时间
     , t1.coid                                                                                       as op_unitid               --提报单位id
     , t1.coidname                                                                                   as op_unitname             --提报单位名称
--      , t1.djcoid                                                                      as dj_unitid            --对接单位id
--      , org.oname                                                                      as dj_unitname          --对接单位名称
     , t1.secondcoid                                                                                 as op_second_unitid        --填报二级单位id
     , t1.secondname                                                                                 as op_second_unitshortname --填报二级单位简称
